# 01 — Move examples to repo root

**What to build:** All standalone code examples are at `examples/` (repo root), making them easier to find and maintain. Old locations (`backend/examples/`, `frontend/examples/`) are empty.
...
- [ ] Old directories are empty and can be deleted
