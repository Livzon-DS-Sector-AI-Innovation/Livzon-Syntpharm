...
- [ ] All `any` types replaced with proper types in equipment components
- [ ] Interfaces defined where needed
- [ ] `tsc --noEmit` passes
- [ ] `pnpm lint` passes (no @typescript-eslint/no-explicit-any warnings in equipment components)
