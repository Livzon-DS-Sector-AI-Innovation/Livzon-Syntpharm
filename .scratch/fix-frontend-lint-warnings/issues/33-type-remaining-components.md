...
- [ ] All `any` types replaced with proper types in remaining components
- [ ] Interfaces defined where needed
- [ ] `tsc --noEmit` passes
- [ ] `pnpm lint` passes (no @typescript-eslint/no-explicit-any warnings in remaining components)
