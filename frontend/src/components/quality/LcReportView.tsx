...
/** 将小数转为百分比显示 */
function toPct(val: number | string | null | undefined, decimals: number = 2): string {
    ...
    <div style={{ maxWidth: 900 }}>
      ...
      <Row gutter={16} style={{ marginBottom: 16 }}>
        ...
        <Col span={8}>
          <Card size="small">
            <Statistic
              title="杂质项目"
              value={report.impurity_results?.length || 0}
              suffix="项"
      ...
      <Collapse
        ...
        items={[
          {
            key: 'standards',
            label: <><SafetyOutlined /> 质量标准（共 {report.standards?.length || 0} 项）</>,
            children: (
              <Table
