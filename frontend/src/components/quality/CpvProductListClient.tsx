...
import { fetchCpvProducts } from "@/lib/api/client/quality-cpv"
import { CpvProductCreateDrawer } from "@/components/quality/CpvProductCreateDrawer"
import { CpvProductWithStats } from "@/types/quality-cpv"

interface Props {
  initialProducts: CpvProductWithStats[]
}

export function CpvProductListClient({ initialProducts }: Props) {
  const [products, setProducts] = useState<CpvProductWithStats[]>(initialProducts)
