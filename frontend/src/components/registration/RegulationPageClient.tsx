...
import { markDocumentRead, fetchAIAnalysis, fetchAIBatchAnalysis } from '@/actions/regulatory-tracker'
...
export function RegulationPageClient() {
  ...
  const handleSingleAnalysis = async (doc: RegulatoryDocument) => {
    ...
    try {
      const result = await fetchAIAnalysis(doc.id)
  ...
  const handleBatchAnalysis = async () => {
    ...
    try {
      const result = await fetchAIBatchAnalysis(documents.map(d => d.id))
