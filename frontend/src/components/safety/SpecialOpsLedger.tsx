...
import {
  ...
  parseSpecialOpsExportQuery,
  exportSpecialOpsLedger,
} from '@/actions/safety'
...
export default function SpecialOpsLedger({ initialStats }: SpecialOpsLedgerProps) {
  ...
  }, [page, pageSize, opType, opLevel, riskLevel, dept, dateRange, debouncedKeyword, isCritical])
  ...
  const handleAIExport = async () => {
    ...
    try {
      const parseData = await parseSpecialOpsExportQuery(exportQuery)
