...
type SpecialOperationPermitResponse = components['schemas']['SpecialOperationPermitResponse']
type SpecialOperationPermitApiResponse = components['schemas']['SpecialOperationPermitApiResponse']
type SpecialOperationPermitListApiResponse = components['schemas']['SpecialOperationPermitListApiResponse']
type SpecialOperationPersonnelResponse = components['schemas']['SpecialOperationPersonnelResponse']
type SpecialOperationPersonnelApiResponse = components['schemas']['SpecialOperationPersonnelApiResponse']
type SpecialOperationPersonnelListApiResponse = components['schemas']['SpecialOperationPersonnelListApiResponse']
type SpecialOperationReportResponse = components['schemas']['SpecialOperationReportResponse']
type SpecialOperationReportApiResponse = components['schemas']['SpecialOperationReportApiResponse']
type SpecialOperationReportListApiResponse = components['schemas']['SpecialOperationReportListApiResponse']

type EhsChangeResponse = components['schemas']['EhsChangeResponse']
type EhsChangeApiResponse = components['schemas']['EhsChangeApiResponse']
type EhsChangeListApiResponse = components['schemas']['EhsChangeListApiResponse']
type DailyRiskReportResponse = components['schemas']['DailyRiskReportResponse']
type DailyRiskReportApiResponse = components['schemas']['DailyRiskReportApiResponse']
type DailyRiskReportListApiResponse = components['schemas']['DailyRiskReportListApiResponse']
type SafetyKnowledgeArticleResponse = components['schemas']['SafetyKnowledgeArticleResponse']
type SafetyKnowledgeArticleApiResponse = components['schemas']['SafetyKnowledgeArticleApiResponse']
type SafetyKnowledgeArticleListApiResponse = components['schemas']['SafetyKnowledgeArticleListApiResponse']
type OhHealthExamResponse = components['schemas']['OhHealthExamResponse']
type OhHealthExamApiResponse = components['schemas']['OhHealthExamApiResponse']
type OhHealthExamListApiResponse = components['schemas']['OhHealthExamListApiResponse']
type OperationRegulationResponse = components['schemas']['OperationRegulationResponse']
type OperationRegulationApiResponse = components['schemas']['OperationRegulationApiResponse']
type OperationRegulationListApiResponse = components['schemas']['OperationRegulationListApiResponse']
type RegulationRevisionResponse = components['schemas']['RegulationRevisionResponse']
...
type ScheduledTaskResponse = components['schemas']['ScheduledTaskResponse']
type ScheduledTaskApiResponse = components['schemas']['ScheduledTaskApiResponse']
...
type HazardIdentificationListApiResponse = components['schemas']['HazardIdentificationListApiResponse']
type HazardIdentificationBatchApiResponse = components['schemas']['HazardIdentificationBatchApiResponse']
type RegulationStagesResponse = components['schemas']['RegulationStagesResponse']
type RegulationStagesApiResponse = components['schemas']['RegulationStagesApiResponse']
type SafetyEnumsApiResponse = components['schemas']['SafetyEnumsApiResponse']
type FeishuWsStatusApiResponse = components['schemas']['FeishuWsStatusApiResponse']
type FeishuWsRestartApiResponse = components['schemas']['FeishuWsRestartApiResponse']
type SpecialOperationLedgerStatsApiResponse = components['schemas']['SpecialOperationLedgerStatsApiResponse']
...
export async function getChecks(
  ...
  return apiFetch<SafetyCheckListApiResponse>(`/api/v1/safety/checks${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getCheck(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SafetyCheckApiResponse>(`/api/v1/safety/checks/${id}`, { headers: authHeaders })
}

export async function createCheck(data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SafetyCheckApiResponse>('/api/v1/safety/checks', {
    method: 'POST',
    headers: authHeaders,
...
export async function updateCheck(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SafetyCheckApiResponse>(`/api/v1/safety/checks/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function submitCheck(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SafetyCheckApiResponse>(`/api/v1/safety/checks/${id}/submit`, {
    method: 'POST',
    headers: authHeaders,
  })
}
...
export async function reviewCheck(id: string, result: string, authHeaders?: Record<string, string>) {
  return apiFetch<SafetyCheckApiResponse>(`/api/v1/safety/checks/${id}/review?result=${result}`, {
    method: 'POST',
    headers: authHeaders,
  })
}
...
export async function confirmCheckApi(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SafetyCheckApiResponse>(`/api/v1/safety/checks/${id}/confirm`, {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function fetchHazardStats(authHeaders?: Record<string, string>) {
  return apiFetch<HazardStatsApiResponse>('/api/v1/safety/hazards/stats', { headers: authHeaders })
}

export async function getHazards(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return apiFetch<HazardListApiResponse>(`/api/v1/safety/hazards${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getHazard(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<HazardApiResponse>(`/api/v1/safety/hazards/${id}`, { headers: authHeaders })
}

export async function getDepartmentLeader(departmentName: string, authHeaders?: Record<string, string>) {
  return apiFetch<DepartmentLeaderApiResponse>(`/api/v1/safety/hazards/department-leader?department_name=${encodeURIComponent(departmentName)}`, { headers: authHeaders })
}

export async function getDepartmentSafetyOfficer(departmentName: string, authHeaders?: Record<string, string>) {
  return apiFetch<DepartmentSafetyOfficerApiResponse>(`/api/v1/safety/hazards/department-safety-officer?department_name=${encodeURIComponent(departmentName)}`, { headers: authHeaders })
}
...
export async function getHazardIdentifications(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/hazard-identifications${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getHIStats(authHeaders?: Record<string, string>) {
  return apiFetch<HazardIdentificationApiResponse>('/api/v1/safety/hazard-identifications/stats', { headers: authHeaders })
}

export async function getHILedgerStats(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return apiFetch<HazardIdentificationApiResponse>(`/api/v1/safety/hazard-identifications/ledger-stats${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getHazardIdentification(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<HazardIdentificationApiResponse>(`/api/v1/safety/hazard-identifications/${id}`, { headers: authHeaders })
}
...
export async function getRegulationStages(regulationId: string, authHeaders?: Record<string, string>) {
  return apiFetch<RegulationStagesApiResponse>(`/api/v1/safety/regulations/${regulationId}/stages`, { headers: authHeaders })
}

export async function createHazardIdentificationBatch(data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<HazardIdentificationBatchApiResponse>('/api/v1/safety/hazard-identifications/batch', {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function updateHazardIdentification(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<HazardIdentificationApiResponse>(`/api/v1/safety/hazard-identifications/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function parseHazardExportQuery(naturalQuery: string, authHeaders?: Record<string, string>) {
  return apiFetch<HazardIdentificationApiResponse>('/api/v1/safety/hazard-identifications/parse-query', {
    method: 'POST',
    headers: authHeaders,
...
export async function exportHazardLedgerPdf(data: unknown, authHeaders?: Record<string, string>) {
...
export async function getSafetyEnums(authHeaders?: Record<string, string>) {
  return apiFetch<SafetyEnumsApiResponse>('/api/v1/safety/enums', { headers: authHeaders })
}

// ============ OperationRegulation ============

export async function getRegulations(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/regulations${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getRegulation(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<OperationRegulationApiResponse>(`/api/v1/safety/regulations/${id}`, { headers: authHeaders })
}

export async function createRegulation(data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<OperationRegulationApiResponse>('/api/v1/safety/regulations', {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function updateRegulation(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<OperationRegulationApiResponse>(`/api/v1/safety/regulations/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function updateSopContent(regulationId: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<OperationRegulationApiResponse>(`/api/v1/safety/regulations/${regulationId}/content`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function reviseRegulation(regulationId: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<RegulationRevisionApiResponse>(`/api/v1/safety/regulations/${regulationId}/revise`, {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function getRevisions(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/revisions${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getRevision(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<RegulationRevisionApiResponse>(`/api/v1/safety/revisions/${id}`, { headers: authHeaders })
}
...
export async function updateRevision(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<RegulationRevisionApiResponse>(`/api/v1/safety/revisions/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function getPersonnelList(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPersonnelListApiResponse>(`/api/v1/safety/special-operation-personnel${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getPersonnel(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPersonnelApiResponse>(`/api/v1/safety/special-operation-personnel/${id}`, { headers: authHeaders })
}

export async function createPersonnel(data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPersonnelApiResponse>('/api/v1/safety/special-operation-personnel', {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function updatePersonnel(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPersonnelApiResponse>(`/api/v1/safety/special-operation-personnel/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function getPermitList(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPermitListApiResponse>(`/api/v1/safety/special-operation-permits${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getPermit(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPermitApiResponse>(`/api/v1/safety/special-operation-permits/${id}`, { headers: authHeaders })
}

export async function createPermit(data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPermitApiResponse>('/api/v1/safety/special-operation-permits', {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function updatePermit(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPermitApiResponse>(`/api/v1/safety/special-operation-permits/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function submitPermit(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPermitApiResponse>(`/api/v1/safety/special-operation-permits/${id}/submit`, {
    method: 'POST',
    headers: authHeaders,
  })
}
...
export async function approvePermit(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPermitApiResponse>(`/api/v1/safety/special-operation-permits/${id}/approve`, {
    method: 'POST',
    headers: authHeaders,
  })
}
...
export async function rejectPermit(id: string, reason: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPermitApiResponse>(`/api/v1/safety/special-operation-permits/${id}/reject?reason=${encodeURIComponent(reason)}`, {
    method: 'POST',
    headers: authHeaders,
  })
}
...
export async function startPermit(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPermitApiResponse>(`/api/v1/safety/special-operation-permits/${id}/start`, {
    method: 'POST',
    headers: authHeaders,
  })
}
...
export async function completePermit(id: string, method: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPermitApiResponse>(`/api/v1/safety/special-operation-permits/${id}/complete?method=${encodeURIComponent(method)}`, {
    method: 'POST',
    headers: authHeaders,
  })
}
...
export async function archivePermit(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationPermitApiResponse>(`/api/v1/safety/special-operation-permits/${id}/archive`, {
    method: 'POST',
    headers: authHeaders,
  })
}
...
export async function getKnowledgeArticles(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/knowledge-articles${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getKnowledgeArticle(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SafetyKnowledgeArticleApiResponse>(`/api/v1/safety/knowledge-articles/${id}`, { headers: authHeaders })
}

export async function createKnowledgeArticle(data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SafetyKnowledgeArticleApiResponse>('/api/v1/safety/knowledge-articles', {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function updateKnowledgeArticle(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SafetyKnowledgeArticleApiResponse>(`/api/v1/safety/knowledge-articles/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function getArticleVersions(id: string, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/knowledge-articles/${id}/versions`, { headers: authHeaders })
}
...
export async function semanticSearchArticles(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/knowledge-articles/semantic-search${buildQueryString(params)}`, { headers: authHeaders })
}
...
export async function getSpecialOperationReports(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationReportListApiResponse>(`/api/v1/safety/special-operation-reports${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getSpecialOperationReport(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationReportApiResponse>(`/api/v1/safety/special-operation-reports/${id}`, { headers: authHeaders })
}

export async function createSpecialOperationReport(data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationReportApiResponse>('/api/v1/safety/special-operation-reports', {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function updateSpecialOperationReport(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationReportApiResponse>(`/api/v1/safety/special-operation-reports/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function submitSpecialOperationReport(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationReportApiResponse>(`/api/v1/safety/special-operation-reports/${id}/submit`, {
    method: 'POST',
    headers: authHeaders,
  })
}
...
export async function approveSpecialOperationReport(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationReportApiResponse>(`/api/v1/safety/special-operation-reports/${id}/approve`, {
    method: 'POST',
    headers: authHeaders,
  })
}
...
export async function rejectSpecialOperationReport(id: string, reason: string, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationReportApiResponse>(`/api/v1/safety/special-operation-reports/${id}/reject?reason=${encodeURIComponent(reason)}`, {
    method: 'POST',
    headers: authHeaders,
  })
}

export async function setSpecialOperationReportCritical(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationReportApiResponse>(`/api/v1/safety/special-operation-reports/${id}/critical`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function getSpecialOperationLedger(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationReportListApiResponse>(`/api/v1/safety/special-operation-ledger${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getSpecialOperationLedgerStats(authHeaders?: Record<string, string>) {
  return apiFetch<SpecialOperationLedgerStatsApiResponse>('/api/v1/safety/special-operation-ledger/stats', { headers: authHeaders })
}

// ============ DailyRiskReport ============

export async function getDailyRiskReports(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/daily-risk-reports${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getDailyRiskReport(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<DailyRiskReportApiResponse>(`/api/v1/safety/daily-risk-reports/${id}`, { headers: authHeaders })
}

export async function createDailyRiskReport(data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<DailyRiskReportApiResponse>('/api/v1/safety/daily-risk-reports', {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function updateDailyRiskReport(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<DailyRiskReportApiResponse>(`/api/v1/safety/daily-risk-reports/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function getHazardRiskOptions(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/hazard-identifications/risk-options${buildQueryString(params)}`, { headers: authHeaders })
}

// ============ EhsChange ============

export async function getEhsChanges(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/ehs-changes${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getEhsChange(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<EhsChangeApiResponse>(`/api/v1/safety/ehs-changes/${id}`, { headers: authHeaders })
}

export async function createEhsChange(data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<EhsChangeApiResponse>('/api/v1/safety/ehs-changes', {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function updateEhsChange(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<EhsChangeApiResponse>(`/api/v1/safety/ehs-changes/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function getOhHazardMonitors(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/oh-hazard-monitors${buildQueryString(params)}`, { headers: authHeaders })
}
...
export async function getOhHealthExams(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/oh-health-exams${buildQueryString(params)}`, { headers: authHeaders })
}

export async function getOhHealthExam(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<OhHealthExamApiResponse>(`/api/v1/safety/oh-health-exams/${id}`, { headers: authHeaders })
}

export async function createOhHealthExam(data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<OhHealthExamApiResponse>('/api/v1/safety/oh-health-exams', {
    method: 'POST',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function updateOhHealthExam(id: string, data: unknown, authHeaders?: Record<string, string>) {
  return apiFetch<OhHealthExamApiResponse>(`/api/v1/safety/oh-health-exams/${id}`, {
    method: 'PUT',
    headers: authHeaders,
    body: JSON.stringify(data),
  })
...
export async function exportSpecialOpsLedger(data: unknown) {
...
export async function getGraphNodes(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/knowledge-graph/nodes${buildQueryString(params)}`, {
    method: 'GET',
    headers: authHeaders,
  })
}
...
export async function getGraphEdges(params: Record<string, unknown> = {}, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/knowledge-graph/edges${buildQueryString(params)}`, {
    method: 'GET',
    headers: authHeaders,
  })
}
...
export async function searchGraphNodes(query: string, nodeTypes?: string, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/knowledge-graph/search${buildQueryString({ query, node_types: nodeTypes })}`, {
    method: 'GET',
    headers: authHeaders,
  })
}
...
export async function getAIWorkflowConfigs(params: Record<string, unknown>, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/ai-workflow-configs${buildQueryString(params)}`, {
    method: 'GET',
    headers: authHeaders,
  })
}
...
export async function getScheduledTasks(params: Record<string, unknown>, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/scheduled-tasks${buildQueryString(params)}`, {
    method: 'GET',
    headers: authHeaders,
  })
}
...
export async function getScheduledTask(id: string, authHeaders?: Record<string, string>) {
  return apiFetch<ScheduledTaskApiResponse>(`/api/v1/safety/scheduled-tasks/${id}`, {
    method: 'GET',
    headers: authHeaders,
  })
}
...
export async function createScheduledTask(data: Record<string, unknown>, authHeaders?: Record<string, string>) {
  return apiFetch<ScheduledTaskApiResponse>('/api/v1/safety/scheduled-tasks', {
    method: 'POST',
    headers: { ...authHeaders, 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
  })
...
export async function getScheduledTaskLogs(taskId: string, authHeaders?: Record<string, string>) {
  return apiFetch<ScheduledTaskLogListApiResponse>(`/api/v1/safety/scheduled-tasks/${taskId}/logs`, {
    method: 'GET',
    headers: authHeaders,
  })
}
...
export async function getDataSourceOptions(authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>('/api/v1/safety/scheduled-tasks/data-sources', {
    method: 'GET',
    headers: authHeaders,
  })
}
...
export async function getFeishuChats(authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>('/api/v1/safety/scheduled-tasks/feishu-chats', {
    method: 'GET',
    headers: authHeaders,
  })
}
...
export async function getHazardRevisionRecords(params: Record<string, unknown>, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/hazard-revision-records${buildQueryString(params)}`, {
    method: 'GET',
    headers: authHeaders,
  })
}
...
export async function getHazardRevisionArchives(params: Record<string, unknown>, authHeaders?: Record<string, string>) {
  return safeApiFetch<unknown[]>(`/api/v1/safety/hazard-revision-archives${buildQueryString(params)}`, {
    method: 'GET',
    headers: authHeaders,
  })
}
