...
export async function createDeviationFlow(data: Record<string, unknown>) {
  return apiFetch('/api/v1/quality/deviation-flow', {
    method: 'POST',
...
export async function updateDeviationFlow(id: string, data: Record<string, unknown>) {
  return apiFetch(`/api/v1/quality/deviation-flow/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  })
}
...
export async function submitDeviationFlow(id: string, targetStatus: string) {
  return apiFetch(`/api/v1/quality/deviation-flow/${id}/submit?target_status=${targetStatus}`, {
    method: 'POST',
  })
}
...
export async function setDefaultDeviationTemplate(templateId: string) {
  return apiFetch(`/api/v1/quality/deviation-settings/message-templates/${templateId}/set-default`, {
    method: 'PUT',
  })
}
...
export async function getDeviations(params?: {
  ...
  return apiFetch(`/api/v1/quality/deviation?${searchParams.toString()}`)
}

export async function getDeviationById(id: string) {
  return apiFetch(`/api/v1/quality/deviation/${id}`)
}

export async function createDeviation(data: DeviationCreate) {
  return apiFetch('/api/v1/quality/deviation', {
    method: 'POST',
    body: JSON.stringify(data),
  })
}
...
export async function submitDeviation(id: string) {
  return apiFetch(`/api/v1/quality/deviation/${id}/submit`, {
    method: 'POST',
  })
}

export async function approveDeviation(id: string, data: { approved: boolean; comment?: string }) {
  return apiFetch(`/api/v1/quality/deviation/${id}/approve`, {
    method: 'POST',
    body: JSON.stringify(data),
  })
}
...
export async function lockBatch(id: string, data: { reason: string }) {
  return apiFetch(`/api/v1/quality/deviation/${id}/lock-batch`, {
    method: 'POST',
...
export async function unlockBatch(id: string) {
  return apiFetch(`/api/v1/quality/deviation/${id}/unlock-batch`, {
    method: 'POST',
  })
}
...
export async function getInvestigations(params?: { deviation_id?: string; page?: number; page_size?: number }) {
  ...
  if (params?.page) searchParams.set('page', String(params.page))
  if (params?.page_size) searchParams.set('page_size', String(params.page_size))
  return apiFetch(`/api/v1/quality/deviation/investigations/list?${searchParams.toString()}`)
}

export async function createInvestigation(data: InvestigationCreate) {
  return apiFetch('/api/v1/quality/deviation/investigations', {
    method: 'POST',
    body: JSON.stringify(data),
  })
}
...
export async function updateInvestigation(id: string, data: Partial<InvestigationCreate>) {
  return apiFetch(`/api/v1/quality/deviation/investigations/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  })
}
...
export async function getCorrections(params?: { deviation_id?: string; status?: string; page?: number; page_size?: number }) {
  ...
  if (params?.page) searchParams.set('page', String(params.page))
  if (params?.page_size) searchParams.set('page_size', String(params.page_size))
  return apiFetch(`/api/v1/quality/deviation/corrections/list?${searchParams.toString()}`)
}

export async function createCorrection(data: CorrectionCreate) {
  return apiFetch('/api/v1/quality/deviation/corrections', {
    method: 'POST',
    body: JSON.stringify(data),
  })
}
...
export async function updateCorrection(id: string, data: Partial<CorrectionCreate>) {
  return apiFetch(`/api/v1/quality/deviation/corrections/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  })
}
...
export async function getClosings(params?: { deviation_id?: string; page?: number; page_size?: number }) {
  ...
  if (params?.page) searchParams.set('page', String(params.page))
  if (params?.page_size) searchParams.set('page_size', String(params.page_size))
  return apiFetch(`/api/v1/quality/deviation/closings/list?${searchParams.toString()}`)
}

export async function createClosing(data: ClosingCreate) {
  return apiFetch('/api/v1/quality/deviation/closings', {
    method: 'POST',
    body: JSON.stringify(data),
  })
}
...
export async function updateClosing(id: string, data: Partial<ClosingCreate>) {
  return apiFetch(`/api/v1/quality/deviation/closings/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  })
}
...
export async function getDeviationStatistics() {
  return apiFetch('/api/v1/quality/deviation/statistics')
}
...
export async function aiGenerateDescription(params: {
  ...
  return apiFetch(`/api/v1/quality/deviation/ai/generate-description?${searchParams.toString()}`, {
    method: 'POST',
  })
}
...
export async function aiAnalyzeImpact(params: {
  ...
  return apiFetch(`/api/v1/quality/deviation/ai/analyze-impact?${searchParams.toString()}`, {
    method: 'POST',
  })
}
...
export async function aiAnalyzeDirectCause(params: {
  ...
  if (params.product_name) searchParams.set('product_name', params.product_name)
  if (params.production_batch) searchParams.set('production_batch', params.production_batch)
  return apiFetch(`/api/v1/quality/deviation/ai/analyze-direct-cause?${searchParams.toString()}`, {
    method: 'POST',
  })
}
...
export async function aiGenerateEmergencyMeasures(params: {
  ...
  if (params.production_batch) searchParams.set('production_batch', params.production_batch)
  if (params.description) searchParams.set('description', params.description)
  return apiFetch(`/api/v1/quality/deviation/ai/generate-emergency-measures?${searchParams.toString()}`, {
    method: 'POST',
  })
}
...
export async function aiAnalyzeRootCause(params: {
  ...
  return apiFetch(`/api/v1/quality/deviation/ai/analyze-root-cause?${searchParams.toString()}`, {
    method: 'POST',
  })
}
...
export async function aiGenerateCAPA(params: {
  ...
  return apiFetch(`/api/v1/quality/deviation/ai/generate-capa?${searchParams.toString()}`, {
    method: 'POST',
  })
}
...
export async function aiGeneratePrevention(params: {
  ...
  if (params.deviation_level) searchParams.set('deviation_level', params.deviation_level)
  if (params.department) searchParams.set('department', params.department)
  return apiFetch(`/api/v1/quality/deviation/ai/generate-prevention?${searchParams.toString()}`, {
    method: 'POST',
  })
}
