  ...
  const handleSubmit = async () => {
    try {
      ...
      const formattedValues = {
        ...values,
        qualification_expiry: values.qualification_expiry ? values.qualification_expiry.toISOString() : undefined,
        safety_license_expiry: values.safety_license_expiry ? values.safety_license_expiry.toISOString() : undefined,
        insurance_expiry: values.insurance_expiry ? values.insurance_expiry.toISOString() : undefined,
      }
      if (editingRecord) {
