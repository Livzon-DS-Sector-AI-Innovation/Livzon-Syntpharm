...
// Type aliases for backward compatibility with dev-xbj branch
export type TrainingPlanListResponse = AnnualTrainingPlanListResponse
export type TrainingPlanResponse = { code: number; message: string; data: AnnualTrainingPlan }
export type TrainingPlanSopListResponse = AnnualTrainingPlanListResponse
export type TrainingPlanSopResponse = { code: number; message: string; data: AnnualTrainingPlan }
export type TrainingRecordListResponse = TrainingLedgerListResponse
export type TrainingRecordResponse = { code: number; message: string; data: TrainingLedgerRecord }
export type TrainingAssessmentListResponse = TrainingLedgerListResponse
export type TrainingAssessmentResponse = { code: number; message: string; data: TrainingLedgerRecord }
export type TrainingApprovalListResponse = AnnualTrainingPlanListResponse
export type TrainingApprovalResponse = { code: number; message: string; data: AnnualTrainingPlan }
...
// ─── Prejob Template Types ───

export interface PrejobTemplateItem {
  seq: number
  content: string
  deadline: string
  trainer: string
...
export interface PrejobTemplate {
  id: string
  department: string
  factory: 'old' | 'new'
...
export type TrainingSessionExtended = TrainingSession

// ─── Training Team & Specialist Types ───
...
export interface TrainingTeam {
  ...
  department?: string
  factory?: string
  specialist_employee_number?: string
  specialist_name?: string
  employee_names?: string[]
  employee_numbers?: string[]
  description?: string
...
export interface TrainingTeamCreateInput {
  name: string
  department?: string
  factory?: string
  specialist_employee_number?: string
...
export interface TrainingTeamUpdateInput {
  name?: string
  department?: string
  factory?: string
  specialist_employee_number?: string
...
export type SyncFromFeishuResponse = { code: number; message: string; data: FeishuSyncResult }

export type SyncToFeishuResponse = { code: number; message: string; data: { feishu_record_id: string } }

// ─── Training Sign-in Sheet Types ───
...
export type TrainingLedgerPageListResponse = { code: number; message: string; data: TrainingLedgerPageRecord[] }

export type TrainingLedgerPageCreateResponse = { code: number; message: string; data: TrainingLedgerPageRecord }

// ─── Annual Training Plan Response Types ───

export type AnnualTrainingPlanItemListResponse = { code: number; message: string; data: AnnualTrainingPlanItem[] }
...
export type SendTrainingSelectTaskResponse = { code: number; message: string }

// ─── Prejob Template Response Types ───

export type PrejobTemplateResponse = { code: number; message: string; data: PrejobTemplate | null }
export type PrejobTemplateSaveResponse = { code: number; message: string; data: PrejobTemplate }
