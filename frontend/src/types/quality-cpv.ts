...
// 创建/更新输入
export type CreateCpvProductInput = components['schemas']['CpvProductCreate']

export type UpdateCpvProductInput = components['schemas']['CpvProductUpdate']

export type CreateCpvParameterInput = components['schemas']['CpvParameterCreate']

export interface CpvProductListResponse {
  items: CpvProductWithStats[]
  total: number
  page: number
  page_size: number
}

export interface CpvBatchListResponse {
  items: CpvBatch[]
  total: number
  page: number
  page_size: number
...
export interface CpvBatchWideListResponse {
  items: CpvBatchWide[]
  total: number
  page: number
  page_size: number
...
export interface CpvImportTaskListResponse {
  items: CpvImportTask[]
  total: number
  page: number
  page_size: number
