...
export const DEPARTMENT_OPTIONS = [
  ...
  { value: '财务部', label: '财务部' },
  { value: '质量保证部', label: '质量保证部' },
  { value: '质量控制部', label: '质量控制部' },
  { value: '注册部', label: '注册部' },
  { value: '技术研发部', label: '技术研发部' },
  { value: '头孢合成制造部', label: '头孢合成制造部' },
  { value: '106车间', label: '106车间' },
  { value: 'AI创新部', label: 'AI创新部' },
  { value: '生产部', label: '生产部' },
  { value: '动力部', label: '动力部' },
  { value: '非头孢制造部', label: '非头孢制造部' },
  { value: '安全环保部', label: '安全环保部' },
  { value: '设备工程部', label: '设备工程部' },
  { value: '采购部', label: '采购部' },
  { value: '201车间', label: '201车间' },
  { value: '202车间', label: '202车间' },
  { value: '101车间', label: '101车间' },
  { value: '102车间', label: '102车间' },
  { value: '103车间', label: '103车间' },
  { value: '301车间', label: '301车间' },
  { value: '302车间', label: '302车间' },
  { value: '303车间', label: '303车间' },
  { value: '溶剂回收车间', label: '溶剂回收车间' },
]

// ── 检查人员部门（与 DEPARTMENT_OPTIONS 统一）──
export const INSPECTOR_DEPARTMENT_OPTIONS = DEPARTMENT_OPTIONS
