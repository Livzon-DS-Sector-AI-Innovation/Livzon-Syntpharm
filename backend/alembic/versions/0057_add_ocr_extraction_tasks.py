...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['asset_id'], ['dossier_writer.chapter_assets.id'], ondelete='CASCADE', name='fk_ocr_tasks_asset_id'),
        sa.ForeignKeyConstraint(['chapter_id'], ['dossier_writer.dossier_chapters.id'], ondelete='CASCADE', name='fk_ocr_tasks_chapter_id'),
        sa.ForeignKeyConstraint(['created_by'], ['identity.users.id'], ondelete='SET NULL', name='fk_ocr_tasks_created_by'),
        sa.ForeignKeyConstraint(['updated_by'], ['identity.users.id'], ondelete='SET NULL', name='fk_ocr_tasks_updated_by'),
