...
def upgrade() -> None:
    ...
    op.alter_column('graph_knowledge_edges', 'relation_type',
                    ...
                    existing_comment='关系类型：cites/supplements/replaces/belongs_to/related_to/conflicts_with',
    ...
    op.alter_column('graph_knowledge_edges', 'status',
                    ...
                    existing_comment='状态：ai_generated/human_confirmed/human_deleted/human_added',
    ...
    op.alter_column('graph_knowledge_nodes', 'entity_type',
                    ...
                    existing_server_default=False,
                    existing_comment='实体子类型：equipment/condition/location/operation/material/standard',
    ...
    op.alter_column('graph_knowledge_nodes', 'status',
                    ...
                    existing_nullable=False,
                    existing_server_default=sa.text("'ai_generated'::character varying"),
                    existing_comment='状态：ai_generated/human_confirmed/deprecated/merged',
...
def downgrade() -> None:
    ...
    op.alter_column('graph_knowledge_nodes', 'entity_type', existing_type=sa.String(length=32), existing_nullable=True, comment='实体子类型：equipment/condition/location/operation/material/standard', schema='safety')
    ...
    op.alter_column('graph_knowledge_edges', 'status', existing_type=sa.String(length=32), existing_nullable=False, existing_server_default=sa.text("'ai_generated'::character varying"), comment='状态：ai_generated/human_confirmed/human_deleted/human_added', schema='safety')
    op.alter_column('graph_knowledge_edges', 'relation_type', existing_type=sa.String(length=32), existing_nullable=False, comment='关系类型：cites/supplements/replaces/belongs_to/related_to/conflicts_with', schema='safety')
