"""0056_add_sync_operation_log

Revision ID: 0056_add_sync_operation_log
Revises: 0055_add_import_batch_id
...
revision: str = '0056_add_sync_operation_log'
down_revision: Union[str, None] = '0055_add_import_batch_id'
