...
S7_2_ASSET_CATEGORIES: list[dict[str, Any]] = []

S7_2_FIELD_MAPPINGS: list[dict[str, Any]] = []
...
S7_3_ASSET_CATEGORIES: list[dict[str, Any]] = []

S7_3_FIELD_MAPPINGS: list[dict[str, Any]] = []
