...
class CpvImportTask(BaseModel):
    ...
    import_mode: Mapped[str] = mapped_column(String(20), nullable=False, comment="导入模式: create/update/overwrite")
    ...
    error_details: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True, comment="错误详情")
