...
async def update_ai_result(
    ...
    if (
        ...
        or content.startswith("<meta")
        or content.startswith("<head")
        or content.startswith("<body")
    ):
...
async def get_task_preview(
    ...
    try:
        ...
        if (
            ai_result_stripped.startswith("<!DOCTYPE")
            or ai_result_stripped.startswith("<html")
            or ai_result_stripped.startswith("<meta")
            or ai_result_stripped.startswith("<head")
