...
def _task_to_response(task: InspectionTask) -> InspectionTaskResponse:
    ...
    if task.equipment:
        ...
        resp.equipment_no = task.equipment.equipment_tag
...
async def create_route(
    ...
    return build_response(data=InspectionRouteResponse.model_validate(route))
        ...
        RouteLocationResponse(
            ...
            equipments=[
                RouteLocationEquipmentResponse(
                    ...
                    equipment_no=(
                        eq.equipment.equipment_tag if (eq.equipment and not eq.equipment.is_deleted) else None
                    ),
                    templates=[
                        RouteEquipmentTemplateResponse(
                            id=rt.id,
...
async def set_route_locations(
        ...
        RouteLocationResponse(
            ...
            equipments=[
                RouteLocationEquipmentResponse(
                    ...
                    equipment_no=eq.equipment.equipment_tag if eq.equipment else None,
                    templates=[
                        RouteEquipmentTemplateResponse(
                            id=rt.id,
                            template_id=rt.template_id,
    ...
    return build_response(data=resp_list)
...
async def create_task(
    ...
    return build_response(data=_task_to_response(task))
...
async def submit_equipment_check(
    ...
    return build_response(data=[InspectionRecordResponse.model_validate(r) for r in result])
...
async def upload_equipment_photo(
    ...
    return build_response(data=InspectionPhotoResponse.model_validate(photo))
...
async def get_task_photos(
    ...
    return build_response(data=[InspectionPhotoResponse.model_validate(p) for p in photos])
...
async def remove_photo(
    ...
    return build_response(message="照片已删除")
...
async def get_history_detail(
    ...
    return build_response(data=model)
...
async def list_schedules(
    ...
    return build_response(schedules)
...
async def create_schedule(
    ...
    return build_response(InspectionScheduleResponse.model_validate(schedule))
