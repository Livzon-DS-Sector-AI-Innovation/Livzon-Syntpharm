...
class FailureSymptom(BaseModel):
    ...
    description: Mapped[str | None] = mapped_column(Text, nullable=True, comment="故障现象描述")
...
class FailureCause(BaseModel):
    ...
    description: Mapped[str | None] = mapped_column(Text, nullable=True, comment="故障原因描述")
    sort_order: Mapped[int] = mapped_column(default=0, comment="排序号")
    is_active: Mapped[bool] = mapped_column(
        Boolean,
        default=True,
...
class FailureAction(BaseModel):
    ...
    description: Mapped[str | None] = mapped_column(Text, nullable=True, comment="维修措施描述")
    sort_order: Mapped[int] = mapped_column(default=0, comment="排序号")
    is_active: Mapped[bool] = mapped_column(
        Boolean,
        default=True,
