...
DEPARTMENT_CONFIG: dict[str, dict[str, str]] = {
    ...
    "101车间": {"leader": "梁学超", "supervisor": "佘祥辉"},
    "102车间": {"leader": "梁学超", "supervisor": "佘祥辉"},
    "103车间": {"leader": "梁学超", "supervisor": "祥辉"},
    "106车间": {"leader": "梁学超", "supervisor": "佘祥辉"},
    "301车间": {"leader": "梁学超", "supervisor": "佘祥辉"},
    "302车间": {"leader": "梁学超", "supervisor": "佘祥辉"},
    "303车间": {"leader": "梁学超", "supervisor": "佘祥辉"},
    "溶剂回收车间": {"leader": "梁学超", "supervisor": "佘祥辉"},
    "头孢合成制造部": {"leader": "梁学超", "supervisor": "佘祥辉"},
    "非头孢制造部": {"leader": "梁学超", "supervisor": "佘祥辉"},
    "生产部": {"leader": "佘祥辉", "supervisor": "温军贤"},
    "安全环保部": {"leader": "宁宇晗", "supervisor": "刘畅", "safety_officer": "王海霞"},
    "技术研发部": {"leader": "梁学超", "supervisor": "温军贤"},
    "注册部": {"leader": "蔡榕斌", "supervisor": "吴钰彬"},
    "人事行政部": {"leader": "陈小娟", "supervisor": "刘畅"},
    "质量保证部": {"leader": "廖庆云", "supervisor": "吴钰彬", "safety_officer": "翁日生"},
    "质量控制部": {"leader": "王凤景", "supervisor": "吴钰彬", "safety_officer": "翁日生"},
}
