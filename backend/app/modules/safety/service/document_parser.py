...
CATEGORY_KEYWORDS = {
    "laws_regulations": [
        "法", "条例", "规定", "办法", "安全生产法", "职业病防治法",
        "消防法", "环境保护法", "劳动法", "合同法"
    ],
    "standards": [
        "GB", "GB/T", "标准", "规范", "ISO", "AQ", "HG", "SH",
        "国家标准", "行业标准", "地方标准"
    ],
    "management_systems": [
        "制度", "规程", "管理办法", "责任制", "操作规范", "作业指导书",
        "管理程序", "工作流程"
    ],
    "accident_cases": [
        "事故", "案例", "通报", "调查报告", "事故分析", "事故案例"
    ],
    "emergency_plans": [
        "预案", "应急", "处置方案", "应急预案", "应急响应", "应急救援"
    ],
    "sds": [
        "SDS", "MSDS", "化学品安全技术说明书", "安全数据表", "物质安全数据表"
    ],
    "training_materials": [
        "培训", "教材", "课件", "教案", "讲义", "培训资料", "考试题库"
    ],
}
...
def extract_tags(filename: str) -> Optional[str]:
    """从文件名提取标签"""
    tags = []
    name = filename.lower()
...
async def parse_document(filename: str, content: bytes) -> dict:
    """
