...
from app.modules.safety.api.ai_workflow import ai_workflow_router
...
from app.modules.safety.api.scheduled_tasks import scheduled_tasks_router
...
router.include_router(ai_workflow_router)
