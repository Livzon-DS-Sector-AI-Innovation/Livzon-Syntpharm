...
def test_parse_bitable_url_extracts_base_table_and_view() -> None:
    ref = parse_bitable_url(
        "https://example.feishu.cn/base/IpMdbEFSlaZRoJstpFLcbTzPn2e?table=tblVpo4DkpnA4MY9&view=vewYHsNQ2G"
    )
...
def test_normalize_app_token_accepts_labelled_text_and_raw_token() -> None:
    assert normalize_app_token("app_token: IpMdbEFSlaZRoJstpFLcbTzPn2e") == "IpMdbEFSlaZRoJstpFLcbTzPn2e"
    assert normalize_app_token("IpMdbEFSlaZRoJstpFLcbTzPn2e") == "IpMdbEFSlaZRoJstpFLcbTzPn2e"


def test_normalize_table_id_accepts_url_labelled_text_and_raw_id() -> None:
    url = "https://example.feishu.cn/base/IpMdbEFSlaZRoJstpFLcbTzPn2e?table=tblVpo4DkpnA4MY9&view=vewYHsNQ2G"
