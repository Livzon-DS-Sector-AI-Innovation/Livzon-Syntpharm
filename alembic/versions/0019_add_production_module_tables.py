...
Revision ID: 0019_add_production_module_tables
...
revision: str = '0019_add_production_module_tables'
down_revision: Union[str, None] = '0018_add_permission_module_tables'
