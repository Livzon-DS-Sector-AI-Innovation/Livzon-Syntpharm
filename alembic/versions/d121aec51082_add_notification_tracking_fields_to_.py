...
def upgrade() -> None:
    ...
    op.add_column(
        "hazard_reports",
        sa.Column(
            "review_notify_error", sa.Text(), nullable=True, comment="复核通知失败原因"
        ),
        schema="safety",
    )
