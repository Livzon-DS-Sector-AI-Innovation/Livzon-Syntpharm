...
down_revision: str | None = "00b1b23aab64"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "module", sa.String(length=50), nullable=False, comment="所属模块编码"
        ),
    ...
    op.create_table(
        "user_roles",
        sa.Column(
            "user_id", sa.UUID(), nullable=False, comment="用户 ID (identity.users)"
        ),
        sa.Column("role_id", sa.UUID(), nullable=False, comment="角色 ID"),
        sa.Column(
            "department_id",
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "user_id", "role_id", "department_id", name="uq_user_roles_triple"
        ),
        schema="permission",
    )
