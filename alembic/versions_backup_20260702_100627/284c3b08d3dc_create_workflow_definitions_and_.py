...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "module_code", sa.String(length=64), nullable=False, comment="模块代码"
        ),
        sa.Column(
            "graph",
            sa.JSON(),
            ...
            comment="graphon 兼容的 graph JSON",
        ),
        sa.Column(
            "is_enabled",
            sa.Boolean(),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.UUID(),
            nullable=False,
            comment="关联 workflow_definitions.id",
        ),
        sa.Column(
            "inputs",
            sa.JSON(),
        ...
        sa.Column(
            "entity_id", sa.String(length=64), nullable=True, comment="关联业务实体 ID"
        ),
        ...
        sa.Column(
            "finished_at", sa.DateTime(timezone=True), nullable=True, comment="完成时间"
        ),
        sa.Column("created_by", sa.String(length=64), nullable=True, comment="创建人"),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column(
