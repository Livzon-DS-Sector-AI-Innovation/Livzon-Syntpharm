...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "workflow_name", sa.String(128), nullable=False, comment="工作流名称"
        ),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["created_by"], ["identity.users.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"], ["identity.users.id"], ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "api_base_url", sa.String(500), nullable=False, comment="API 基础 URL"
        ),
