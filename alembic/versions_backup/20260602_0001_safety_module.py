...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_safety_checks_check_no", "safety_checks", ["check_no"], schema="safety"
    )
    op.create_index(
        "idx_safety_checks_status", "safety_checks", ["status"], schema="safety"
    )
    op.create_index(
        "idx_safety_checks_check_type", "safety_checks", ["check_type"], schema="safety"
    )
    op.create_index(
        "idx_safety_checks_check_date", "safety_checks", ["check_date"], schema="safety"
    )
    ...
    op.create_index(
        "idx_hazard_reports_hazard_no", "hazard_reports", ["hazard_no"], schema="safety"
    )
    op.create_index(
        "idx_hazard_reports_status", "hazard_reports", ["status"], schema="safety"
    )
    op.create_index(
        "idx_hazard_reports_hazard_type",
        "hazard_reports",
        ["hazard_type"],
        schema="safety",
    )
    op.create_index(
        "idx_hazard_reports_hazard_level",
        "hazard_reports",
        ["hazard_level"],
        schema="safety",
    )
    op.create_index(
        "idx_hazard_reports_department",
        "hazard_reports",
        ["department"],
        schema="safety",
    )
    op.create_index(
        "idx_hazard_reports_check_id", "hazard_reports", ["check_id"], schema="safety"
    )
    ...
    op.create_index(
        "idx_accidents_accident_no", "accidents", ["accident_no"], schema="safety"
    )
    op.create_index("idx_accidents_status", "accidents", ["status"], schema="safety")
    op.create_index(
        "idx_accidents_accident_type", "accidents", ["accident_type"], schema="safety"
    )
    op.create_index(
        "idx_accidents_happened_at", "accidents", ["happened_at"], schema="safety"
    )
    ...
    op.create_index(
        "idx_safety_trainings_training_no",
        "safety_trainings",
        ["training_no"],
        schema="safety",
    )
    op.create_index(
        "idx_safety_trainings_status", "safety_trainings", ["status"], schema="safety"
    )
    op.create_index(
        "idx_safety_trainings_training_type",
        "safety_trainings",
        ["training_type"],
        schema="safety",
    )
    op.create_index(
        "idx_safety_trainings_training_date",
        "safety_trainings",
        ["training_date"],
        schema="safety",
    )
    ...
    op.create_table(
        ...
        sa.Column("department", sa.String(length=100), nullable=True),
        sa.Column(
            "attendance", sa.Boolean(), server_default=sa.text("true"), nullable=False
        ),
    ...
    op.create_index(
        "idx_training_records_training_id",
        "training_records",
        ["training_id"],
        schema="safety",
    )
    op.create_index(
        "idx_training_records_employee_id",
        "training_records",
        ["employee_id"],
        schema="safety",
    )
