...
down_revision: str | None = "8669b3dc5093"
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "ck_maintenance_plans_status", "maintenance_plans", schema="equipment"
    )
    op.drop_constraint(
        "ck_maintenance_plans_frequency_unit", "maintenance_plans", schema="equipment"
    )
    op.drop_constraint(
        "ck_maintenance_plans_plan_type", "maintenance_plans", schema="equipment"
    )
    ...
    op.drop_constraint(
        "fk_maintenance_plans_equipment_id", "maintenance_plans", schema="equipment"
    )
