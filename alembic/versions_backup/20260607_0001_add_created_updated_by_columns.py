...
def upgrade() -> None:
    ...
    op.add_column(
        "capas", sa.Column("created_by", sa.Uuid(), nullable=True), schema="quality"
    )
    op.add_column(
        "capas", sa.Column("updated_by", sa.Uuid(), nullable=True), schema="quality"
    )
    op.create_foreign_key(
        "fk_capas_created_by",
        "capas",
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_attachment_reviews_updated_by", "attachment_reviews", schema="quality"
    )
    op.drop_constraint(
        "fk_attachment_reviews_created_by", "attachment_reviews", schema="quality"
    )
    ...
    op.drop_constraint(
        "fk_department_contacts_updated_by", "department_contacts", schema="quality"
    )
    op.drop_constraint(
        "fk_department_contacts_created_by", "department_contacts", schema="quality"
    )
