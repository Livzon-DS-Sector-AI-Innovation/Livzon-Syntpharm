...
down_revision: str | None = "4cc0d68d67fe"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "period_type", sa.String(length=20), nullable=False, comment="巡检周期类型"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "equipment_id", sa.Uuid(), nullable=True, comment="单设备ID（单设备模式）"
        ),
        sa.Column("template_id", sa.Uuid(), nullable=False, comment="检查模板ID"),
        sa.Column(
            "plan_type", sa.String(length=20), nullable=False, comment="巡检类型"
        ),
        ...
        sa.Column(
            "overall_result", sa.String(length=10), nullable=True, comment="总体结果"
        ),
        sa.Column(
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        None, "inspection_records", schema="equipment", type_="foreignkey"
    )
    op.drop_constraint(
        None, "inspection_records", schema="equipment", type_="foreignkey"
    )
