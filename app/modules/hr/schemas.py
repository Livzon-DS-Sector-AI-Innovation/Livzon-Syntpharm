...
class EmployeeBase(BaseModel):
    ...
    emergency_contact_name: str | None = Field(None, max_length=64, description="紧急联系人姓名")
    emergency_contact_phone: str | None = Field(None, max_length=32, description="紧急联系人电话")
    emergency_contact_relation: str | None = Field(None, max_length=32, description="紧急联系人关系")
...
class TrainingSessionBase(BaseModel):
    ...
    select_tasks: list[dict[str, Any]] | None = Field(None, description="多部门选择任务列表")
...
class AnnualTrainingPlanItemUpdate(BaseModel):
    ...
    target_audience: str | None = Field(None, max_length=256)  # type: ignore[no-redef]
    position_and_count: str | None = Field(None, max_length=256)  # type: ignore[no-redef]
    training_method: str | None = Field(None, max_length=64)  # type: ignore[no-redef]
    training_hours: float | None = Field(None)  # type: ignore[no-redef]
    confirmer: str | None = Field(None, max_length=64)  # type: ignore[no-redef]
    confirm_date: date | None = Field(None)  # type: ignore[no-redef]
    remarks: str | None = Field(None, max_length=512)  # type: ignore[no-redef]
    sort_order: int | None = Field(None)  # type: ignore[no-redef]
...
class TrainingTeamResponse(BaseModel):
    ...
    specialist_name: str
    employee_names: list[Any] | None = None
    employee_numbers: list[Any] | None = None
    created_at: datetime | None = None
    updated_at: datetime | None = None
...
class CandidateResponse(CandidateBase):
    ...
    id: UUID
    resume_attachments: list[dict[str, Any]] | None = None
    feishu_record_id: str | None = None
    feishu_synced_at: date | None = None
...
class PrejobTemplateCreate(BaseModel):
    ...
    department: str = Field(..., max_length=64, description="部门名称")
    factory: str = Field("old", max_length=8, description="厂区: old=旧厂, new=新厂")
    items: list[PrejobTemplateItem] = Field(default_factory=list, description="10行培训计划条目")
