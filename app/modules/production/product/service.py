...
class ProductService:
    ...
    async def create_product(self, data: ProductCreate) -> Any:
        # 检查是否已存在
    ...
    async def get_products_by_workshop(self, workshop: str) -> Any:
        return await self.repo.get_by_workshop(workshop)

    async def get_all_products(self) -> Any:
        return await self.repo.get_all()

    async def update_product(self, product_id: uuid.UUID, data: ProductUpdate) -> Any:
